package com.app.paymong.ui.main
...
fun Main(navController: NavController) {
    ...
    val characterState = remember { mutableStateOf(CommonCode.EGG) }
    ...
    Column(
        ...
        Row(
            ...
            if (characterState.value != CommonCode.EGG){
                ...
                Button(
                    onClick = {
                        /*
                            알 생성 로직 호출
                        */
                        characterState.value = CommonCode.Level1
                    },
                    modifier = Modifier.size(60.dp)
                ) {
