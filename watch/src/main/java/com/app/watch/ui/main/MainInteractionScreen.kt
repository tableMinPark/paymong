...
fun MainInteraction(
    ...
    Column(
        ...
        Row(
            ...
            Button(
                // nav -> FeedScreen()
                onClick = { navController.navigate(NavItem.Feed.route) },
        ...
        Row(
            ...
            Button(
                // nav -> ActivityScreen()
                onClick = { navController.navigate(NavItem.Activity.route) },
                modifier = Modifier.size(60.dp)
            ) {
            ...
            Button(
                // nav -> BattleScreen()
                onClick = { navController.navigate(NavItem.Battle.route) },
                modifier = Modifier.size(60.dp)
            ) {
